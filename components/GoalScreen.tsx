...
export function GoalScreen({ onReplay }: Props) {
  return (
    <div
      className="fixed inset-0 z-40 flex flex-col items-center justify-center bg-gradient-to-b from-teal-600/95 via-amber-100/95 to-yellow-50/95 p-6 text-center"
      role="dialog"
      aria-modal="true"
